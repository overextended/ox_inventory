...
AddEventHandler('linden_inventory:useItem',function(item)
	...
	if IsPedInAnyVehicle(PlayerPedId(), true) and Config.ItemList[item.name] ~= nil and Config.ItemList[item.name].canUseInVehicle ~=nil and Config.ItemList[item.name].canUseInVehicle == false then
