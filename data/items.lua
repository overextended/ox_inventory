return {
    ...
    ['clothingbag'] = {
        ...
        client = {
            export = 'salife_oxinv.clothingbag'
        },
        buttons = {
            -- {
            --     label = 'Open bag',
            --     action = function(slot)
            --         exports.salife_oxinv:openClothingBag(slot)
            --     end
            -- },
            {
                label = 'Change bag name',
                action = function(slot)
                    exports.salife_oxinv:editClothingBag(slot)
                end
            },
            {
                label = 'Put clothes into bag',
                action = function(slot)
                    exports.salife_oxinv:putClothesIntoClothingBag(slot)
                end
            },
            {
                label = 'Wear',
                action = function(slot)
                    exports.salife_oxinv:wearClothingBag(slot)
                end
            }
        }
    },
