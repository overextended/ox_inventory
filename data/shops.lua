return {
	...
	PoliceArmoury = {
		...
		blip = {
			...
			{ name = 'ammo-beanbag', price = 0, metadata = { description = "Police Property" }, },
			...
			{ name = 'WEAPON_BEANBAGSHOTGUN', price = 0, metadata = { registered = true, description = "Police Property", police_property = true, serial = 'POL'}, grade = 1, },
