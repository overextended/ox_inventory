...
INSERT INTO `items` (`name`, `label`, `weight`, `can_remove`, `stackable`, `closeonuse`, `description`) VALUES
	...
	('WEAPON_ASSAULTRIFLE', 'Assault Rifle', 3470, 1, 1, 0, NULL),
	('WEAPON_ASSAULTRIFLE_MK2', 'Assault Rifle MK2', 3300, 1, 1, 0, NULL),
	('WEAPON_ASSAULTSHOTGUN', 'Assault Shotgun', 3100, 1, 1, 0, NULL),
	('WEAPON_ASSAULTSMG', 'Assault SMG', 2850, 1, 1, 0, NULL),
	('WEAPON_BALL', 'Ball', 149, 1, 1, 0, NULL),
	('WEAPON_BAT', 'Bat', 1134, 1, 1, 0, NULL),
	('WEAPON_BOTTLE', 'Bottle', 350, 1, 1, 0, NULL),
	('WEAPON_BULLPUPRIFLE', 'Bullpup Rifle', 2900, 1, 1, 0, NULL),
	('WEAPON_BULLPUPRIFLE_MK2', 'Bullpup Rifle MK2', 2900, 1, 1, 0, NULL),
	('WEAPON_BULLPUPSHOTGUN', 'Bullpup Shotgun', 3100, 1, 1, 0, NULL),
	('WEAPON_BZGAS', 'BZ Gas', 600, 1, 1, 0, NULL),
	('WEAPON_CARBINERIFLE', 'Carbine Rifle', 3100, 1, 1, 0, NULL),
	('WEAPON_CARBINERIFLE_MK2', 'Carbiner Rifle MK2', 3000, 1, 1, 0, NULL),
	('WEAPON_COMBATMG', 'Combat MG', 10000, 1, 1, 0, NULL),
	('WEAPON_COMBATMG_MK2', 'Combat MG MK2', 10500, 1, 1, 0, NULL),
	('WEAPON_COMBATPDW', 'Combat PDW', 2700, 1, 1, 0, NULL),
	('WEAPON_COMBATPISTOL', 'Combat Pistol', 970, 1, 1, 0, NULL),
	('WEAPON_COMPACTRIFLE', 'Compact Rifle', 2700, 1, 1, 0, NULL),
	('WEAPON_CROWBAR', 'Crowbar', 2500, 1, 1, 0, NULL),
	('WEAPON_DAGGER', 'Dagger', 800, 1, 1, 0, NULL),
	('WEAPON_DBSHOTGUN', 'Double Barrel Shotgun', 3175, 1, 1, 0, NULL),
	('WEAPON_DOUBLEACTION', 'Double Action Revolver', 940, 1, 1, 0, NULL),
	('WEAPON_FIREEXTINGUISHER', 'Fire Extinguisher', 8616, 1, 1, 0, NULL),
	('WEAPON_FIREWORK', 'Firework Launcher', 1000, 1, 1, 0, NULL),
	('WEAPON_FLARE', 'Flare', 235, 1, 1, 0, NULL),
	('WEAPON_FLAREGUN', 'Flare Gun', 1000, 1, 1, 0, NULL),
	('WEAPON_FLASHLIGHT', 'Flashlight', 125, 1, 1, 0, NULL),
	('WEAPON_GOLFCLUB', 'Golf Club', 330, 1, 1, 0, NULL),
	('WEAPON_GRENADE', 'Grenade', 600, 1, 1, 0, NULL),
	('WEAPON_GUSENBERG', 'Gusenberg', 4900, 1, 1, 0, NULL),
	('WEAPON_HAMMER', 'Hammer', 1200, 1, 1, 0, NULL),
	('WEAPON_HATCHET', 'Hatchet', 1000, 1, 1, 0, NULL),
	('WEAPON_HAZARDCAN', 'Hazard Can', 12000, 1, 1, 0, NULL),
	('WEAPON_HEAVYPISTOL', 'Heavy Pistol', 1100, 1, 1, 0, NULL),
	('WEAPON_HEAVYSHOTGUN', 'Heavy Shotgun', 3600, 1, 1, 0, NULL),
	('WEAPON_HEAVYSNIPER', 'Heavy Sniper', 14000, 1, 1, 0, NULL),
	('WEAPON_HEAVYSNIPER_MK2', 'Heavy Sniper MK2', 10432, 1, 1, 0, NULL),
	('WEAPON_KNIFE', 'Knife', 300, 1, 1, 0, NULL),
	('WEAPON_KNUCKLE', 'Knuckle Dusters', 300, 1, 1, 0, NULL),
	('WEAPON_MACHETE', 'Machete', 1000, 1, 1, 0, NULL),
	('WEAPON_MACHINEPISTOL', 'Machine Pistol', 1400, 1, 1, 0, NULL),
	('WEAPON_MARKSMANPISTOL', 'Marksman Pistol', 1588, 1, 1, 0, NULL),
	('WEAPON_MARKSMANRIFLE', 'Marksman Rifle', 7500, 1, 1, 0, NULL),
	('WEAPON_MARKSMANRIFLE_MK2', 'Marksman Rifle', 4000, 1, 1, 0, NULL),
	('WEAPON_MG', 'Machine Gun', 9000, 1, 1, 0, NULL),
	('WEAPON_MICROSMG', 'Micro SMG', 4000, 1, 1, 0, NULL),
	('WEAPON_MINISMG', 'Mini SMG', 2770, 1, 1, 0, NULL),
	('WEAPON_MOLOTOV', 'Molotov', 1800, 1, 1, 0, NULL),
	('WEAPON_NIGHTSTICK', 'Nightstick', 1000, 1, 1, 0, NULL),
	...
	('WEAPON_PUMPSHOTGUN', 'Pump Shotgun', 3400, 1, 1, 0, NULL),
	('WEAPON_PUMPSHOTGUN_MK2', 'Pump Shotgun MK2', 3200, 1, 1, 0, NULL),
	('WEAPON_REVOLVER', 'Revolver', 2260, 1, 1, 0, NULL),
	('WEAPON_REVOLVER_MK2', 'Revolver MK2', 1500, 1, 1, 0, NULL),
	...
	('WEAPON_SNSPISTOL_MK2', 'SNS Pistol MK2', 465, 1, 1, 0, NULL),
	('WEAPON_SPECIALCARBINE', 'Special Carbine', 3000, 1, 1, 0, NULL),
	('WEAPON_SPECIALCARBINE_MK2', 'Special Carbine MK2', 3370, 1, 1, 0, NULL),
	('WEAPON_STICKYBOMB', 'Sticky Bomb', 1000, 1, 1, 0, NULL),
	('WEAPON_STUNGUN', 'Tazer', 227, 1, 1, 0, NULL),
	('WEAPON_SWEEPERSHOTGUN', 'Sweeper Shotgun', 4400, 1, 1, 0, NULL),
	('WEAPON_SWITCHBLADE', 'Switch Blade', 300, 1, 1, 0, NULL),
