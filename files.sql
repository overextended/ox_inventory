...
INSERT INTO `items` (`name`, `label`, `weight`, `rare`, `can_remove`, `stackable`, `closeonuse`, `description`) VALUES
    ('ammo-musket', 'Musket ammo', 20, 0, 1, 1, 0, ''),
    ('ammo-rifle', '5.56', 20, 0, 1, 1, 0, ''),
    ('ammo-rifle2', '7.62', 20, 0, 1, 1, 0, ''),
    ('ammo-45', '.45 ACP', 20, 0, 1, 1, 0, ''),
    ('ammo-shotgun', '12 gauge', 20, 0, 1, 1, 0, ''),
    ('ammo-heavysniper', '.50 BMG', 20, 0, 1, 1, 0, ''),
    ('ammo-50', '.50 AE', 20, 0, 1, 1, 0, ''),
    ('ammo-22', '.22 long rifle', 20, 0, 1, 1, 0, ''),
    ('ammo-flare', 'Flare', 20, 0, 1, 1, 0, ''),
    ('ammo-sniper', '7.62 NATO', 20, 0, 1, 1, 0, ''),
    ('ammo-9', '9mm', 20, 0, 1, 1, 0, ''),
    ('ammo-38', '.38 long colt', 20, 0, 1, 1, 0, ''),
    ('ammo-44', '.44 magnum', 20, 0, 1, 1, 0, ''),
