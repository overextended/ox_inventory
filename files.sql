...
INSERT INTO `items` (`name`, `label`, `weight`, `rare`, `can_remove`, `stackable`, `closeonuse`, `description`) VALUES
    ('ammo-musket', 'ammo-musket', 20, 0, 1, 1, 0, ''),
    ('ammo-rifle', 'ammo-rifle', 20, 0, 1, 1, 0, ''),
    ('ammo-rifle2', 'ammo-rifle2', 20, 0, 1, 1, 0, ''),
    ('ammo-45', 'ammo-45', 20, 0, 1, 1, 0, ''),
    ('ammo-shotgun', 'ammo-shotgun', 20, 0, 1, 1, 0, ''),
    ('ammo-heavysniper', 'ammo-heavysniper', 20, 0, 1, 1, 0, ''),
    ('ammo-50', 'ammo-50', 20, 0, 1, 1, 0, ''),
    ('ammo-22', 'ammo-22', 20, 0, 1, 1, 0, ''),
    ('ammo-flare', 'ammo-flare', 20, 0, 1, 1, 0, ''),
    ('ammo-sniper', 'ammo-sniper', 20, 0, 1, 1, 0, ''),
    ('ammo-9', 'ammo-9', 20, 0, 1, 1, 0, ''),
    ('ammo-38', 'ammo-38', 20, 0, 1, 1, 0, ''),
    ('ammo-44', 'ammo-44', 20, 0, 1, 1, 0, ''),
    ('water', 'Water', 600, 0, 1, 1, 1, ''),
    ('burger', 'Burger', 220, 0, 1, 1, 1, ''),
    ('cola', 'eCola', 350, 0, 1, 1, 1, ''),
    ('money', 'Money', 1, 0, 1, 1, 1, ''),
    ('black_money', 'Money', 1, 0, 1, 1, 1, ''),
