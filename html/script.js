	...
	if (showhotbar == null) {
		...
		for(i = 0; i < 5; i++) {
			...
			if (item != null) {
				...
				$hotslot.html('<div id="itembox-label">'+item.label+'</div><div class="hotslot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + image + '.png'+'" alt="' + item.name + '" /></div>');
			}
...
HSN.NotifyItems = function(item, text) {
	...
	let image = item.name
					if (item.metadata.image != undefined) { image = item.metadata.image }
	$itembox.html('<div id="itembox-action">' + text + '</div><div id="itembox-label">'+item.label+'</div><div class="itembox-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + image + '.png'+'" alt="' + item.name + '" /></div>');
	...
	$.each(data.inventory, function (i, item) {
		if (item != null) {
			...
			if ((item.name).split("_")[0] == "WEAPON" && item.metadata.durability !== undefined) {
				$(".inventory-main-leftside").find("[inventory-slot=" + item.slot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + image + '.png'+'" alt="' + item.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(item.count, item.name) + ' ' + weightFormat(item.weight/1000 * item.count) + '</p></div><div class="item-slot-label"><div class="item-slot-durability-bar"></div>' + item.label + '</div>');
				...
				$(".inventory-main-leftside").find("[inventory-slot=" + item.slot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + image + '.png'+'" alt="' + item.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(item.count, item.name) + ' ' + weightFormat(item.weight/1000 * item.count) + '</p></div><div class="item-slot-label">' + item.label + '</div></div>');
				$(".inventory-main-leftside").find("[inventory-slot=" + item.slot + "]").data("ItemData", item);
				$(".inventory-main-leftside").find("[inventory-slot=" + item.slot + "]").addClass("drag-item");
			}
		}
					...
					if (item.metadata.image != undefined) { image = item.metadata.image }
						if ((item.name).split("_")[0] == "WEAPON" && item.metadata.durability !== undefined) {
							if (currency == 'money' || currency == 'black_money' || currency == 'bank' || currency == undefined) {
								$(".inventory-main-rightside").find("[inventory-slot=" + item.slot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + image + '.png'+'" alt="' + item.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(item.price, 'money') + '</p></div><div class="item-slot-label"><div class="item-slot-durability-bar"></div>' + item.label + '</div>');
							} else {
								$(".inventory-main-rightside").find("[inventory-slot=" + item.slot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + image + '.png'+'" alt="' + item.name + '" /></div><div class="item-slot-count"><p>' + item.price + ' ' + currency + '</p></div><div class="item-slot-label"><div class="item-slot-durability-bar"></div>' + item.label + '</div>');
							}
							...
							if (currency == 'money' || currency == 'black_money' || currency == 'bank' || currency == undefined) {
								$(".inventory-main-rightside").find("[inventory-slot=" + item.slot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + image + '.png'+'" alt="' + item.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(item.price, 'money') + '</p></div><div class="item-slot-label">' + item.label + '</div></div>');
							} else {
								$(".inventory-main-rightside").find("[inventory-slot=" + item.slot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + image + '.png'+'" alt="' + item.name + '" /></div><div class="item-slot-count"><p>' + item.price + ' ' + currency + '</p></div><div class="item-slot-label">' + item.label + '</div></div>');
							}
							$(".inventory-main-rightside").find("[inventory-slot=" + item.slot + "]").data("ItemData", item).data("location", data.rightinventory.id);
							//$(".inventory-main-rightside").find("[inventory-slot=" + item.slot + "]").addClass("drag-item");
						}
			...
			$.each(data.rightinventory.inventory, function (i, item) {
				if (item != null) {
					...
					if ((item.name).split("_")[0] == "WEAPON" && item.metadata.durability !== undefined) {
						...
						$(".inventory-main-rightside").find("[inventory-slot=" + item.slot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + image + '.png'+'" alt="' + item.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(item.count, item.name) + ' ' + weightFormat(item.weight/1000 * item.count) + '</p></div><div class="item-slot-label"><div class="item-slot-durability-bar"></div>' + item.label + '</div>');
						$(".inventory-main-rightside").find("[inventory-slot=" + item.slot + "]").data("ItemData", item);
						$(".inventory-main-rightside").find("[inventory-slot=" + item.slot + "]").addClass("drag-item");
							let durability = HSN.InventoryGetDurability(item.metadata.durability)
							$(".inventory-main-rightside").find("[inventory-slot=" + item.slot + "]").find(".item-slot-durability-bar").css({"background-color": durability[0],"width": durability[1]});
					} else {
						$(".inventory-main-rightside").find("[inventory-slot=" + item.slot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + image + '.png'+'" alt="' + item.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(item.count, item.name) + ' ' + weightFormat(item.weight/1000 * item.count) + '</p></div><div class="item-slot-label">' + item.label + '</div></div>');
						$(".inventory-main-rightside").find("[inventory-slot=" + item.slot + "]").data("ItemData", item);
						$(".inventory-main-rightside").find("[inventory-slot=" + item.slot + "]").addClass("drag-item");
					}
				}
		...
		if (toItem !== undefined ) { // stack
			...
			if (count <= fromItem.count || count <= toItem.count) {
				if(((fromItem.name).split("_")[0] == "WEAPON" && fromItem.metadata.durability !== undefined) && ((toItem.name).split("_")[0] == "WEAPON" && toItem.metadata.durability !== undefined)) {
					// fromItem durability
					if (fromItem.metadata.durability) { let durability = HSN.InventoryGetDurability(fromItem.metadata.durability) }
					// toItem durability
					if (toItem.metadata.durability) { let durability2 = HSN.InventoryGetDurability(toItem.metadata.durability) }
					toInventory.find("[inventory-slot=" + toSlot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + fromimage + '.png'+'" alt="' + fromItem.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(fromItem.count, fromItem.name) + ' ' + weightFormat(fromItem.weight/1000 * fromItem.count) + '</p></div><div class="item-slot-label"><div class="item-slot-durability-bar"></div>' + fromItem.label + '</div>');
					fromInventory.find("[inventory-slot=" + fromSlot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + toimage + '.png'+'" alt="' + toItem.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(toItem.count, toItem.name) + ' ' + weightFormat(toItem.weight/1000 * toItem.count) + '</p></div><div class="item-slot-label"><div class="item-slot-durability-bar"></div>' + toItem.label + '</div>');
					...
					success = true
						...
						toInventory.find("[inventory-slot=" + toSlot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + toimage + '.png'+'" alt="' + toItem.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(newcount, toItem.name) + ' ' + weightFormat(toItem.weight/1000 * newcount) + '</p></div><p><div class="item-slot-label">' + toItem.label + '</div>');
					...
					if ((toItem.name).split("_")[0] == "WEAPON" && toItem.metadata.durability !== undefined) {
						...
						toInventory.find("[inventory-slot=" + toSlot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + fromimage + '.png'+'" alt="' + fromItem.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(fromItem.count, fromItem.name) + ' ' + weightFormat(fromItem.weight/1000 * fromItem.count) + '</p></div><p><div class="item-slot-label">' + fromItem.label + '</div>');
						toInventory.find("[inventory-slot=" + toSlot + "]").data("ItemData", fromItem);
						fromInventory.find("[inventory-slot=" + fromSlot + "]").data("ItemData", toItem);
						fromInventory.find("[inventory-slot=" + fromSlot + "]").addClass("drag-item");
						toInventory.find("[inventory-slot=" + toSlot + "]").addClass("drag-item");
						...
						toInventory.find("[inventory-slot=" + toSlot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + fromimage + '.png'+'" alt="' + fromItem.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(fromItem.count, fromItem.name) + ' ' + weightFormat(fromItem.weight/1000 * fromItem.count) + '</p></div><div class="item-slot-label"><div class="item-slot-durability-bar"></div>' + fromItem.label + '</div>');
						toInventory.find("[inventory-slot=" + toSlot + "]").find(".item-slot-durability-bar").css({"background-color":durability[0],"width":durability[1]});
						fromInventory.find("[inventory-slot=" + fromSlot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + toimage + '.png'+'" alt="' + toItem.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(toItem.count, toItem.name) + ' ' + weightFormat(toItem.weight/1000 * toItem.count) + '</p></div><p><div class="item-slot-label">' + toItem.label + '</div>');
						fromInventory.find("[inventory-slot=" + fromSlot + "]").data("ItemData", toItem);
						toInventory.find("[inventory-slot=" + toSlot + "]").data("ItemData", fromItem);
						fromInventory.find("[inventory-slot=" + fromSlot + "]").addClass("drag-item");
						toInventory.find("[inventory-slot=" + toSlot + "]").addClass("drag-item");
						...
						fromInventory.find("[inventory-slot=" + fromSlot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + toimage + '.png'+'" alt="' + toItem.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(toItem.count) + ' ' + weightFormat(toItem.weight/1000 * toItem.count) + '</p></div><p><div class="item-slot-label">' + toItem.label + '</div>');
						toInventory.find("[inventory-slot=" + toSlot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + fromimage + '.png'+'" alt="' + fromItem.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(fromItem.count) + ' ' + weightFormat(fromItem.weight/1000 * fromItem.count) + '</p></div><p><div class="item-slot-label">' + fromItem.label + '</div>');
						fromInventory.find("[inventory-slot=" + fromSlot + "]").data("ItemData", toItem);
						toInventory.find("[inventory-slot=" + toSlot + "]").data("ItemData", fromItem);
						fromInventory.find("[inventory-slot=" + fromSlot + "]").addClass("drag-item");
						toInventory.find("[inventory-slot=" + toSlot + "]").addClass("drag-item");
			...
			if (count <= fromItem.count) {
				if(((fromItem.name).split("_")[0] == "WEAPON" && fromItem.metadata.durability !== undefined)) {
					...
					if (fromItem.count > count) {
						...
						fromInventory.find("[inventory-slot=" + fromSlot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + oldImage + '.png'+'" alt="' + oldItemData.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(oldItemData.count, oldItemData.name) + ' ' + weightFormat(oldItemData.weight/1000 * oldItemData.count) + '</p></div><div class="item-slot-label">' + oldItemData.label + '</div>');
						fromInventory.find("[inventory-slot=" + fromSlot + "]").data("ItemData", oldItemData);
						toInventory.find("[inventory-slot=" + toSlot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + newImage + '.png'+'" alt="' + newItemData.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(newItemData.count, newItemData.name) + ' ' + weightFormat(newItemData.weight/1000 * newItemData.count) + '</p></div><div class="item-slot-label">' + newItemData.label + '</div>');
						...
						HSN.RemoveItemFromSlot(fromInventory,fromSlot)
						toInventory.find("[inventory-slot=" + toSlot + "]").html('<div class="item-slot-img"><img src="https://cdn.altered-city.fr/esx_inventoryhud/' + fromimage + '.png'+'" alt="' + fromItem.name + '" /></div><div class="item-slot-count"><p>' + numberFormat(count, fromItem.name) + ' ' + weightFormat(fromItem.weight/1000 * count) + '</p></div><p><div class="item-slot-label">' + fromItem.label + '</div>');
						toInventory.find("[inventory-slot=" + toSlot + "]").data("ItemData", fromItem);
						toInventory.find("[inventory-slot=" + toSlot + "]").addClass("drag-item");
						toInventory.find("[inventory-slot=" + toSlot + "]").removeClass("itemdragclose");
						fromInventory.find("[inventory-slot=" + fromSlot + "]").addClass("itemdragclose");
