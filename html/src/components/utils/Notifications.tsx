...
const Notify = (data: NotificationProps) => {
    toast(data.text, {
        ...
        style: {
            backgroundColor: data.type === undefined ? 'rgb(52, 152, 219)' : (data.type === 'success' ? 'rgb(39, 174, 96)' : 'rgb(231, 76, 60)')
        }
    })
}
...
const Notifications: React.FC = () => {
    ...
    return (
        <Toaster toastOptions={{ // options defined here apply to all toasts
            style: {
                color: 'white',
                borderRadius: '5px',
                padding: '4px'
