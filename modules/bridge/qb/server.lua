...
export('qb-inventory.CanAddItem', function(source, item, amount)
...
export('qb-inventory.OpenInventory', function(invType, id, _, source)
    Inventory.forceOpenInventory(source, invType, id)
end)
export('qb-inventory.AddItem', function(source, item, amount, slot, info)
    return Inventory.AddItem(source, item, amount, info, slot)
end)
export('qb-inventory.RemoveItem', function(source, item, amount, slot)
    return Inventory.RemoveItem(source, item, amount, nil, slot)
end)
