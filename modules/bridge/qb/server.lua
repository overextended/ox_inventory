...
export('qb-inventory.GetTotalWeight',function(items)
    return Inventory.CalculateWeight(items)
end)
...
export('qb-inventory.AddItem',function(source,item, amount, info, slot)
