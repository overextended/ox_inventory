...
function Utils.Disarm(currentWeapon, newSlot)
	...
	if currentWeapon then
		...
		if newSlot ~= -1 then
			...
			local sleep = (PlayerData.job.name == 'police' and (GetWeapontypeGroup(currentWeapon.hash) == 416676503 or GetWeapontypeGroup(currentWeapon.hash) == 690389602)) and 450 or 1400
